  ...
  return (
    <div className='btn-container'>
      <div className='btn-group'>
        <button className='btn AC-col' onClick={(e)=>clickEventHandling(e.target.innerText)}>AC</button>
        <button className='btn' onClick={(e)=>clickEventHandling(e.target.innerText)}>(</button>
        <button className='btn' onClick={(e)=>clickEventHandling(e.target.innerText)}>)</button>
        <button className='btn clear-btn' onClick={(e)=>clickEventHandling(e.target.innerText)}>⌦</button>
      </div>
      <div className='btn-group'>
      <button className='btn' onClick={(e)=>clickEventHandling(e.target.innerText)}>7</button>
        ...
        <button className='btn math-col' onClick={(e)=>clickEventHandling(e.target.innerText)}>/</button>
      </div>
      <div className='btn-group'>
